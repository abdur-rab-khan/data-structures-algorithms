...
/*
    ...
    ◉ So in two pointer technique as name suggest they use two pointers (indices) to traverse on the
        data structure especially on "ARRAY", "STRING", "LINKED-LIST". The pointers often represent
        (left indices, right indices) moving towards each other on in same direction are manipulate
