...
// 👉 count_if: It's similar to "count", but we can pass a function to count element by condition
void usingCountIf() {
...
// 👉 find: Return an iterator of first element if it matched, otherwise return end()
void usingFind() {
    cout << endl << "--> Using Count-If: " << endl;
...
// 👉 find_if: Return an iterator of first matched element using given function, otherwise return end
void usingFindIf() {
    cout << endl << "--> Using Count-If: " << endl;
