...
void TodoManager::printAllTodoContent() {
  std::cout << "------------------ ALL TODOS LIST --------------------"
            << std::endl;
  for (size_t i = 0; i < todos.size(); ++i) {
    std::cout << "Sr no. " << i + 1 << " " << todos.at(i).getContent()
              << std::endl;
  }
  std::cout << "-----------------------------------------------" << std::endl;
}
...
void TodoManager::addTodo() {
  ...
  if (!content.empty()) {
    ...
    std::cout << ">>>>>>>>>>>> TODO IS ADDED SUCCESSFULLY <<<<<<<<<<<<<"
              << std::endl;
  } else {
...
void TodoManager::updateTodo() {
  ...
  if (choice > todos.size()) {
    ...
    std::cout << ">>>>>>>>>>>> TODO IS UPDATED SUCCESSFULLY <<<<<<<<<<<<<"
              << std::endl;
  }
};
...
void TodoManager::removeTodo() {
  ...
  if (choice > todos.size()) {
    ...
    std::cout << ">>>>>>>>>>>> TODO IS REMOVE SUCCESSFULLY <<<<<<<<<<<<<"
              << std::endl;
  }
};
