...
7. [**Check Palindrome:**](./problems/easy/others/06_check_palindrome.cpp) Palindrome is a technique used to check whether original string is same to reverse string.
